...
VALUES
(1, 'Computing School', 'CS',
 'Computing and software systems', 'ACTIVE'),
(2, 'Business Administration', 'BA',
 'Business and management studies', 'ACTIVE'),
(3, 'Information Technology', 'IT',
 'Information technology and systems', 'ACTIVE');

INSERT IGNORE INTO programs
(id, department_id, name, code, duration_years, status)
VALUES
(1, 1, 'Software Engineering', 'SE', 4.0, 'ACTIVE'),
(2, 1, 'Computer Science', 'CSE', 4.0, 'ACTIVE'),
(3, 3, 'Information Technology', 'IT', 4.0, 'ACTIVE'),
(4, 2, 'Business Administration', 'BBA', 4.0, 'ACTIVE');
...
(
  ...
  'Course registration and timetable information is now available.',
  'ALL',
  1
),
(
  2,
  'Fee deadline',
  'Please check your fee balance and settle outstanding payments before the deadline.',
  'STUDENT',
  1
);
...
(
  ...
  'SYSTEM',
  NULL,
  'Initial StudentHub development data loaded.'
);